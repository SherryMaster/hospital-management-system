"""
Django settings for Hospital Management System API.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-fb1_mjh7gipzk@z-ohkyvo)8ulunrpog7(@x166)mxy-nb+2^a')
...
# Hospital Management System specific settings
